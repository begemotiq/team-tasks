...
func (m *MockteamLister) List(ctx context.Context, userID int64) ([]models.Team, error) {
	m.ctrl.T.Helper()
...
func (mr *MockteamListerMockRecorder) List(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockteamLister)(nil).List), ctx, userID)
}
